...
0},is_staff:function(){return this.has_data()&&"undefined"!=typeof this.data.is_staff&&this.data.is_staff?!0:!1},name:function(){return this.has_data()&&"undefined"!=typeof this.data.name?this.data.name:""},theme:function(){return this.has_data()&&"undefined"!=typeof this.data.theme_id?this.data.theme_id:0},url:function(){return this.has_data()&&"undefined"!=typeof this.data.url?this.data.url:""}}}();yootil.ajax=function(){return{bind:function(a,b,c,d,g){var f=$(b),a="ajax"+a.substr(0,1).toUpperCase()+a.substr(1);if(1==f.length&&(g=g?g:b,a&&c&&b.length))f[a](function(a,f,e){(!0===d||RegExp(d,"i").test(e.url))&&$.proxy(c,g,a,f,e,b)()});return yootil}}}();yootil.sound=function(){return{audio_obj:null,play:function(a){$.browser.msie?(this.audio_obj||(this.audio_obj=$('<bgsound src="#" autostart="true" loop="1" width="1" height="1" id="yootil_sound_player">').appendTo($("body"))),this.audio_obj.attr("src",a)):(this.audio_obj&&this.audio_obj.remove(),this.audio_obj=$('<embed src="'+a+'" autostart="true" width="1" loop="1" height="1" id="yootil_sound_player">').appendTo($("body")))}}}();yootil.locationcheck=function(){return{__is_page:function(a){return proboards.data&&proboards.data("route")&&proboards.data("route").name==a},board:function(){return this.__is_page("board")},bookmarks:function(){return this.__is_page("bookmarks")},calendar:function(){return this.__is_page("calendar")||this.__is_page("calendar_month")},calendar_day:function(){return this.__is_page("calendar_day")},forum:function(){return this.__is_page("home")||this.__is_page("forum")},members:function(){return this.__is_page("members")},
message_list:function(){return this.__is_page("conversations")},message_thread:function(){return this.__is_page("conversation")},posting:function(){return this.posting_quote()||this.posting_reply()||this.posting_thread()},posting_quote:function(){return this.__is_page("quote_posts")},posting_reply:function(){return this.__is_page("new_post")},posting_thread:function(){return this.__is_page("new_thread")},profile_activity:function(){return this.__is_page("show_user_activity")},profile_following:function(){return this.__is_page("show_user_following")},
profile_friends:function(){return this.__is_page("show_user_friends")},profile_gift:function(){return this.__is_page("show_user_gift")},profile_groups:function(){return this.__is_page("show_user_groups")},profile_home:function(){return this.__is_page("user")},profile_edit_admin:function(){return this.__is_page("edit_user_admin")},profile_edit_avatar:function(){return this.__is_page("edit_user_avatar")},profile_edit_badges:function(){return this.__is_page("edit_user_badges")},profile_edit_notifications:function(){return this.__is_page("edit_user_notifications")},
profile_edit_personal:function(){return this.__is_page("edit_user_personal")},profile_edit_privacy:function(){return this.__is_page("edit_user_privacy")},profile_edit_settings:function(){return this.__is_page("edit_user_settings")},profile_edit_social:function(){return this.__is_page("edit_user_social")},profile_notifications:function(){return this.__is_page("show_user_notifications")},recent_posts:function(){return this.__is_page("all_recent_posts")},recent_threads:function(){return this.__is_page("recent_threads")},
