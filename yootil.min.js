/**
* http://pixeldepth.net / http://sz-ex.com / http://yootil.pixeldepth.net - Ver: 0.3.0
*/
...
b){this.set(a,"",b);return this},set:function(a,b,c,d){if(this.exists(a)){d&&(b=JSON.stringify(b));if("undefined"==typeof c||!c||!c.toString().length)c=b,b=void 0;this.pb_key_obj(a).set(c,b)}return this}}}();
